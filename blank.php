        ...
        <div class="container-fluid">
              ...
              <div class="card shadow">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <center><div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $_SESSION['username']; ?></div></center>
                        <hr>
            ...
            <div class="col-md-3">
              <div class="card border-left-info shadow">
                  ...
                  <h6 class="m-0 font-weight-bold text-danger">Total Deliveries</h6></div>
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="h5 mb-0 font-weight-bold text-gray-800">To Be Updated</div>
                    </div>
                  </div>
                </div>
              </div>
