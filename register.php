...
<head>
  ...
  <title>Darklite Logistics - Registration</title>
            ...
            <div class="p-5">
              ...
              <form class="user" action="<?php $_SERVER['PHP_SELF'];?>" method="post">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="password" name="password" class="form-control form-control-user" id="exampleLastName" placeholder="Password" required>
                  </div>
                </div>
